...
<html>
	<head>
		...
		<title> adicionar Lista de compra</title>
	...
	<body>
		...
		<form class="ui form" action="adicionarListaCompra" method="post">
			<div class="field">
					<div class="field">
						<label for="name">Nome:</label>
						<input type="text" name="listanome" id="listanome" required><br><br>
					</div>	
			</div>
